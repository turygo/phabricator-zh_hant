...
After completing configuration, copy the **Client ID** and **Client Secret** to the fields above.' => NULL,
  ...
  '%s Token' => NULL,
  '%s Transforms' => '%s 转换',
  '%s Triggered Audit' => '%s 触发稽查',
  '%s Unit(s)' => NULL,
  '%s Unsound Test(s)' => NULL,
  '%s User(s) Need Approval' => NULL,
  '%s You have not added authentication providers yet. Use "%s" to add a provider, which will let users register new Phabricator accounts and log in.' => '%s 您尚未加入认证提供者，请使用 "%s" 来加入提供者来让使用者可注册新 Phabricator 帐号并登入。',
  '%s abandoned %s.' => NULL,
  ...
  '%s activated this badge.' => NULL,
  '%s activated this dashboard' => '%s 启用了这个资讯看板。',
  '%s activated this key.' => NULL,
  ...
  '%s activated this project.' => '%s 启用了这个项目。',
  '%s activated this repository.' => '%s 启用了这个档案库。',
  ...
  '%s added %d project hashtag(s): %s.' => '%s 加入了 %d 个项目 Hashtag: %s。',
  '%s added %d project member(s): %s.' => '%s 加入了 %d 位项目成员: %s。',
  '%s added %d subscriber(s): %s.' => '%s 加入了 %d 位订阅者: %s。',
  '%s added %s account member(s) to %s: %s.' => '%s 加入了 %s 位帐号成员到 %s: %s。',
  '%s added %s account member(s): %s.' => '%s 加入了 %s 位帐号成员。',
  '%s added %s automation blueprint(s): %s.' => '%s 加入了 %s 个自动化蓝图: %s。',
  '%s added %s badge(s) for %s: %s.' => '%s 加入了 %s 个徽章给 %s: %s。',
  '%s added %s badge(s): %s.' => NULL,
  '%s added %s commit(s) for %s: %s.' => '%s 加入了 %s 笔提交给 %s: %s。',
  '%s added %s commit(s) to %s: %s.' => '%s 加入了 %s 笔提交到 %s: %s。',
  '%s added %s commit(s): %s.' => '%s 加入了 %s 笔提交: %s。',
  '%s added %s contributor(s) for %s: %s.' => '%s 加入了 %s 位贡献者给 %s: %s。',
  '%s added %s contributor(s): %s.' => '%s 加入了 %s 位贡献者: %s。',
  '%s added %s dashboard(s) for %s: %s.' => '%s 加入了 %s 个资讯看板给 %s: %s。',
  ...
  '%s added %s file(s) for %s: %s.' => '%s 加入了 %s 个档案给 %s: %s。',
  '%s added %s file(s): %s.' => '%s 加入了 %s 个档案: %s。',
  '%s added %s files(s).' => '%s 加入了 %s 个档案。',
  ...
  '%s added %s mock(s) for %s: %s.' => '%s 加入了 %s 个模型给 %s: %s。',
  '%s added %s mock(s): %s.' => '%s 加入了 %s 个模型: %s。',
  '%s added %s owner(s): %s.' => '%s 加入了 %s 个拥有者: %s。',
  '%s added %s panel(s) for %s: %s.' => '%s 加入了 %s 个面板给 %s: %s。',
  '%s added %s panel(s): %s.' => '%s 加入了 %s 个面板: %s。',
  '%s added %s parent task(s) for %s: %s.' => NULL,
  '%s added %s parent task(s): %s.' => NULL,
  '%s added %s project(s) for %s: %s.' => '%s 加入了 %s 个项目给 %s: %s。',
  '%s added %s project(s) to %s: %s.' => '%s 加入了 %s 个项目到 %s: %s。',
  '%s added %s project(s): %s.' => '%s 加入了 %s 个项目: %s。',
  ...
  '%s added %s reviewer(s) for %s: %s.' => '%s 加入了 %s 位审查员给 %s: %s。',
  '%s added %s reviewer(s): %s.' => '%s 加入了 %s 位审查员: %s。',
  '%s added %s revision(s) to %s: %s.' => '%s 加入了 %s 个修订到 %s: %s。',
  '%s added %s revision(s): %s.' => '%s 加入了 %s 个修订: %s。',
  '%s added %s subscriber(s) for %s: %s.' => '%s 加入了 %s 位订阅者给 %s: %s。',
  '%s added %s subscriber(s): %s.' => '%s 加入了 %s 位订阅者: %s。',
  '%s added %s subtask(s) for %s: %s.' => NULL,
  '%s added %s subtask(s): %s.' => NULL,
  '%s added %s task(s) for %s: %s.' => '%s 加入了 %s 个工作给 %s: %s。',
  ...
  '%s added %s watcher(s) for %s: %s.' => '%s 加入了 %s 位监视者给 %s: %s。',
  '%s added %s watcher(s): %s.' => '%s 加入了 %s 位监视者: %s。',
  '%s added %s.' => '%s 加入了 %s。',
  '%s added CCs to this revision.' => NULL,
  '%s added a comment to %s.' => '%s 加入了评论到 %s。',
  ...
  '%s archived this post.' => NULL,
  '%s archived this project.' => '%s 封存了这个项目。',
  ...
  '%s changed the background color of the project workboard.' => NULL,
  '%s changed the callsign for this repository from "%s" to "%s".' => '%s 更改了给这个档案库的代号从 "%s" 为 "%s"。',
  '%s changed the credential for this URI from %s to %s.' => NULL,
  '%s changed the default branch from "%s" to "%s".' => NULL,
  '%s changed the default filter for the project workboard.' => NULL,
  '%s changed the default queue from %s to %s.' => NULL,
  '%s changed the default sort order for the project workboard.' => NULL,
  ...
  '%s changed the short name of this repository from "%s" to "%s".' => '%s 更改了这个档案库的简短名称从 "%s" 为 "%s"。',
  ...
  '%s conveted this from an all day event.' => NULL,
  ...
  '%s created this build.' => '%s 建立了这个 Build。',
  ...
  '%s created this project.' => '%s 建立了这个项目。',
  '%s created this provider.' => '%s 建立了这个提供者。',
  '%s created this publisher.' => NULL,
  '%s created this queue.' => NULL,
  '%s created this repository.' => '%s 建立了这个档案库。',
  ...
  '%s disabled the workboard for this project.' => NULL,
  '%s disabled this URI.' => NULL,
  '%s disabled this application.' => NULL,
  ...
  '%s edited dashboard(s) for %s, added %s: %s; removed %s: %s.' => '%s 编辑了资讯看板给 %s，已加入 %s: %s; 已移除 %s: %s。',
  ...
  '%s edited panel(s) for %s, added %s: %s; removed %s: %s.' => '%s 编辑了面板给 %s，已加入 %s: %s; 已移除 %s: %s。',
  ...
  '%s enabled this URI.' => NULL,
  '%s enabled this application.' => NULL,
  ...
  '%s enabled this provider.' => '%s 开启了此提供者。',
  ...
  '%s named this room "%s".' => '%s 命名此讨会议室为 "%s"。',
  ...
  '%s removed %d image(s): %s.' => '%s 移除了 %d 位参与者: %s。',
  ...
  '%s removed %s as the repository for this revision.' => '%s 移除了这个修订的档案库 %s。',
  ...
  '%s removed %s dashboard(s) for %s: %s.' => '%s 移除了 %s 个资讯看板给 %s: %s。',
  ...
  '%s removed %s panel(s) for %s: %s.' => '%s 移除了 %s 个面板给 %s: %s。',
  ...
  '%s renamed this application from "%s" to "%s".' => NULL,
  ...
  '%s requested changes to this revision.' => '%s 请修变更这个修订。',
  ...
  '%s set the repository for this revision to %s.' => '%s 设定这个修订的档案库为 %s。',
  ...
  '%s unlocked this project\'s membership.' => '%s 解除锁定了此项目的成员资格。',
...
You\'ve resolved (or ignored) all outstanding setup issues. You can review issues in the **Config** application, under **[[ %s | Setup Issues ]]**.' => NULL,
  ...
  'A blog\'s details change.' => '部落格的详细资讯变更。',
  'A blog\'s subscribers change.' => '部落格的订阅者变更。',
...
Either adjust the configuration setting %s or restart the daemons. Daemons should attempt to run as the proper user when restarted.' => NULL,
  ...
  'A task\'s associated projects change.' => '工作关联的项目变更。',
  ...
  'Activate Project' => '启用项目',
  'Activate Repository' => '启用档案库',
  'Activate Rule' => '启用规则',
  'Activate Space' => NULL,
  'Activate Space: %s' => NULL,
  'Activate Subproject' => NULL,
  'Activate and Show Column' => NULL,
  'Activate read-only mode for maintenance or disaster recovery.' => NULL,
  'Activate this repository to begin or resume import.' => '启用此档案库来开始或继续汇入。',
  ...
  'Add Answer' => '加入解答',
  'Add Auditors' => '加入稽查员',
  'Add Auth Provider' => '加入认证提供者',
  'Add Authentication Factor' => '加入认证 Factor',
  'Add Authentication Provider' => '加入认证提供者',
  'Add Binding' => NULL,
  'Add Build Step' => NULL,
  'Add CCs' => NULL,
  'Add Column' => '加入栏',
...
Users who are CC\'d on the email itself are also automatically subscribed if Phabricator knows which accounts are linked to their email addresses.' => NULL,
  'Add project tags.' => NULL,
  'Add projects' => '加入项目',
  'Add projects: %s.' => '加入项目: %s。',
  'Add related projects.' => '加入相关项目。',
  'Add reviewers' => '加入审查者',
...
Generally, you should use this option only in a development environment where ssh-keygen is broken and it is inconvenient to fix it, and only if you are certain you understand the risks. You should never cache a PKCS8 file you did not generate yourself.' => NULL,
  ...
  'Address' => '地址',
  'Address %s' => '地址 %s',
  'Address Already Verified' => '地址已经验证过',
  'Address Duplicated in Input' => NULL,
  'Address Error' => NULL,
  'Address Verified' => '已验证地址',
  ...
  'Adjust Path' => NULL,
  'Adjust Timezone' => NULL,
  'Adjust project colors.' => NULL,
  'Adjust project icons.' => NULL,
...
You can choose which priority is the default for newly created tasks with `%s`.' => NULL,
  ...
  'Almanac service, device, property and namespace names may only contain lowercase letters, numbers, hyphens, and periods.' => NULL,
  ...
  'Alternate' => NULL,
  'Alternate File Domain Not Configured' => '未设定替代的档案网域',
  ...
  'An initiative\'s status changes.' => '提案的状态变更。',
  ...
  'Archive Paste' => NULL,
  'Archive Post' => NULL,
  'Archive Project' => '封存项目',
  'Archive Rule' => '封存规则',
  'Archive Space' => NULL,
  'Archive Space: %s' => NULL,
  'Archive Subproject' => NULL,
  ...
  'Are you sure you want to delete this address? You will no longer be able to use it to login.' => '您确定要删除这个地址? 您将无法使用该地址登入。',
  'Are you sure you want to delete this email address?' => '您确定要删除这个邮件地址?',
  ...
  'Are you sure you want to uninstall this dashboard as the home page for %s?' => '您确定要移除安装这个资讯看板做为首页给 %s?',
...
Data is normally attached by calling the corresponding %s method on the Query class when the object is loaded. You can also call the corresponding %s method explicitly.' => NULL,
  ...
  'Audits' => '稽查',
  'Auth' => '认证',
  'Auth Application' => '认证应用程式',
  'Auth Factor' => '认证 Factor',
  'Auth Invite' => NULL,
  'Auth Provider' => '认证提供者',
  ...
  'Authentication Factors' => '认证 Factor',
  'Authentication Failure' => NULL,
  'Authentication Sessions' => '认证工作阶段',
  'Authentication Tokens' => '认证 Token',
  ...
  'Browse Not Tagged With Any Projects' => '浏览未被标记任何项目',
  'Browse Objects' => '浏览物件',
  'Browse Owners' => '浏览拥有者',
  ...
  'Browse Queues' => NULL,
  'Browse Repositories' => '浏览档案库',
  'Browse Repository' => '浏览档案库',
  'Browse Responsible Users' => '浏览负责的使用者',
  'Browse Results' => NULL,
  'Browse Reviewers' => '浏览审查员',
  'Browse Service Types' => NULL,
  ...
  'Browse Symbols' => NULL,
  'Browse User Projects' => '浏览使用者项目',
  'Browse Users' => '浏览使用者',
  'Browse Users and Projects' => '浏览使用者与项目',
  'Browse Values' => NULL,
  'Browse Viewer' => NULL,
...
You should configure a CDN or alternate file domain to mitigate this risk. Configuring a CDN will also improve performance. See [[ %s | %s ]] for instructions.' => NULL,
  ...
  'Can Create Repositories' => '可建立档案库',
  ...
  'Can Manage Cluster Services' => NULL,
  ...
  'Can\'t Analyze' => NULL,
  'Can\'t Toggle Unloaded File' => '无法切换未载入的档案',
  ...
  'Change' => '变更',
  'Change Background Color' => NULL,
  'Change Default Values' => '变更预设值',
  'Change Details' => '变更明细',
  'Change Estimate' => NULL,
  'Change Field Order' => '变更栏位顺序',
  'Change File' => NULL,
  'Change Image' => NULL,
  ...
  'Change the project icon.' => NULL,
  'Change the project tag color.' => NULL,
  ...
  'Choose which day a calendar week should begin on.' => '请选择月历中的周要以那天开始。',
  ...
  'Close Question' => '关闭问题',
  'Close Revision' => NULL,
  'Close This Task As a Duplicate Of' => NULL,
  ...
  'Close and Merge Selected Tasks' => NULL,
  ...
  'Cluster Repository Status' => '丛集档案库状态',
  'Cluster Setup' => '丛集安装',
  'Cluster Status' => '丛集状态',
...
IMPORTANT: This feature is new, experimental, and not supported. Use it at your own risk.' => NULL,
  'Configure Badges Forms' => NULL,
  'Configure Blog Post Forms' => NULL,
  'Configure Calendar Event Forms' => NULL,
  'Configure Conpherence messaging.' => '设定会议讯息传送。',
  'Configure Differential code review.' => '设定 Differential 程式码审查。',
  'Configure Diffusion repository browsing.' => '设定 Diffusion 档案库浏览。',
  ...
  'Configure Project Forms' => '设定项目表单',
  'Configure Projects.' => '设定项目。',
  ...
  'Configure blueprints so Drydock can build resources, like hosts and working copies.' => '设定蓝图，让 Drydock 可以建置资源，如: 主机与工作复本。',
  'Configure core options, including URIs.' => '设定核心选项，包含 URI。',
  'Configure creation and editing blog posts in Phame.' => NULL,
  'Configure creation and editing forms in Badges.' => NULL,
  ...
  'Configure files and file storage.' => '设定档案与档案储存库。',
  'Configure forms for creating and editing packages in Owners.' => '设定在拥有者用来建立与编辑套件的表单。',
  'Configure forms for creating projects.' => '设定用来建立项目的表单。',
...
The keys in this map are viewable MIME types; the values are the MIME types they are delivered as when they are viewed in the browser.' => NULL,
  ...
  'Configuring File Storage' => '设定档案储存库',
  'Confirm' => NULL,
  ...
  'Create Git Repository' => '建立 Git 档案库',
  ...
  'Create Meme' => NULL,
  'Create Menu Item' => NULL,
  'Create Merchant' => NULL,
  'Create Mercurial Repository' => '建立 Mercurial 档案库',
  ...
  'Create Publisher' => NULL,
  'Create Pull Request' => '建立 Pull Request',
  'Create Queue' => '建立序列',
  'Create Release Product' => NULL,
  'Create Repository' => '建立档案库',
  'Create Repository URI' => '建立档案库 URI',
  'Create Room' => '建立会议室',
  'Create Rule' => '建立规则',
  'Create Service' => '建立服务',
  ...
  'Create Subproject' => '建立子项目',
  'Create Subtask' => '建立子工作',
  'Create Subversion Repository' => '建立 Subversion 档案库',
  'Create Task' => '建立工作',
  'Create Task...' => '建立工作...',
  ...
  'Create a new Git repository.' => '建立一个新的 Git 档案库。',
  'Create a new Maniphest task.' => NULL,
  'Create a new Mercurial repository.' => '建立一个新的 Mercurial 档案库。',
  'Create a new Revision...' => '建立新修订...',
  'Create a new Subversion repository.' => '建立一个新的 Subversion 档案库。',
  ...
  'Create easy to remember shortcuts to images and memes.' => NULL,
...
See [[ %s | Projects User Guide ]] in the documentation for details. This process can not be undone.' => NULL,
...
Reason: %s' => NULL,
  ...
  'Current Viewer\'s Projects' => '目前检视者的项目',
...
These tattered edges are an expected consequence of destroying objects, and the Phabricator upstream will not help you fix them. We strongly recommend disabling or archiving objects instead.' => NULL,
  ...
  'Disable Filetree' => '关闭档案树',
  'Disable Form' => '关闭表单',
  'Disable HTTP Basic Auth' => NULL,
  'Disable Highlighting' => '关闭语法标示',
  'Disable Mail' => '关闭邮件通知',
  'Disable Menu Item' => NULL,
  'Disable Notifications, Feed, and Herald' => NULL,
  'Disable OAuth Application' => NULL,
  'Disable PHP %s' => NULL,
  'Disable Plan' => NULL,
  'Disable Project Mail' => NULL,
  ...
  'Do not dwell in the past, do not dream of the future, concentrate the mind on the present moment.' => '不要停留在过去；不要梦想著未来；要集中精神，活在当下。',
  ...
  'Driven Snow' => NULL,
  'Drop Files to Upload' => '拖曳档案到此处上传',
  ...
  'Drydock Pool' => NULL,
  'Drydock Repository Operation' => 'Drydock 档案库操作',
  'Drydock Repository Operation %d' => 'Drydock 档案库操作 %d',
  'Drydock Repository Operations' => 'Drydock 档案库操作',
...
' => NULL,
  ...
  'Edit Background Color' => '编辑背景色彩: %s',
  'Edit Badge' => NULL,
  'Edit Badge: %s' => NULL,
  ...
  'Edit Build Plan: %s' => NULL,
  'Edit Builtin Item' => NULL,
  ...
  'Edit Menu' => '编辑选单',
  'Edit Menu Item' => '编辑项目',
  'Edit Menu Item: %s' => '编辑选单: %s',
  'Edit Merchant' => NULL,
  'Edit Merchant %d %s' => NULL,
  'Edit Mock' => '建立模型',
  'Edit Mock: %s' => NULL,
  'Edit Mocks' => '编辑模型',
  'Edit Mulitple Files' => '编辑多档案',
  ...
  'Edit Package' => '编辑套件',
  'Edit Package Package Configurations' => NULL,
  'Edit Package Publisher Configurations' => NULL,
  'Edit Package Version Configurations' => NULL,
  ...
  'Edit Related Tasks...' => '编辑相关的工作...',
  'Edit Repositories' => '编辑档案库',
  'Edit Repository URI' => '编辑档案库 URI',
  'Edit Repository URI %d' => '编辑档案库 URI %d',
  'Edit Repository: %s' => '编辑档案库: %s',
  'Edit Revision' => '编辑修订',
...
%s' => NULL,
  ...
  'Email: Add Address' => '邮件: 加入地址',
  'Email: Change Primary' => '邮件: 更改主要',
  'Email: Reassign' => '邮件: 重新指派',
...
For more detailed output, you can also run manual builds from the command line:
  ...
  'Exclaim' => NULL,
  'Exclude' => NULL,
  'Exclude results tagged with this project.' => '排除结果中标记此项目的项目。',
  'Excuse:' => NULL,
  'Execute Query' => '执行查询',
  ...
  'Expires' => '到期',
  'Explain Why' => NULL,
  'Explain what\'s new in this diff.' => '说明在这个 diff 更新了什么。',
...
Phabricator' => NULL,
  ...
  'Global Default Settings' => NULL,
  'Global Defaults' => NULL,
  'Global Rule' => '全域规则',
...
Do not enable this option if you serve (or plan to ever serve) unsecured content over plain HTTP. It is very difficult to undo this change once users\' browsers have accepted the setting.' => NULL,
  ...
  'Harbormaster' => NULL,
  'Harbormaster Build Plans' => 'Harbormaster 建置计划',
...
`%s`' => NULL,
  ...
  'Hide Manually Uploaded Files' => '隐藏手动上传的档案',
  'Hide Query' => '隐藏查询',
  'Hide Search' => '隐藏搜寻',
  ...
  'Host and Browse Repositories' => '管理与浏览档案库',
  'Host for SMTP.' => NULL,
  'Host for SSH connections to repositories.' => NULL,
  'Host of the event.' => NULL,
  'Host: %s' => '主机: %s',
  'Hosted' => '代管',
  'Hosted Repositories' => '代管的档案库',
  'Hosted and Remote Repositories' => '代管及远端档案库',
  'Hosted by %s' => NULL,
...
After enabling prototypes, you can selectively uninstall them (like normal applications).' => NULL,
  ...
  'If activated now, this repository will become a new hosted repository. To observe an existing repository instead, configure it in the %s panel.' => '若现在启用，将会代管一个新的档案库，若要观查 (Observe) 一个已存在的档案库，请在 %s 面板设定。',
  'If activated now, this repository will observe an existing remote repository and begin importing changes.' => '若现在启用，此档案库将会观查 (Observe) 一个已存在的远端档案库并开始汇入变更。',
...
//You will still receive some administrative email, like password reset email.//' => NULL,
  ...
  'If you have difficulty reading the Phabricator UI, this setting may make Phabricator more accessible.' => NULL,
  ...
  'If you lock this project, members will be prevented from leaving it.' => '若您锁定项目，可避免成员离开项目。',
...
NOTE: URIs are not validated, the URI must return HTTP status 200 within 30 seconds, and no permission checks are performed.' => NULL,
  ...
  'If you unlock this project, members will be free to leave.' => '若您取消锁定项目，成员将可自由离开。',
  ...
  'If you want to import only part of a repository, like `trunk/`, you can set a path in **Import Only**. Phabricator will ignore commits which do not affect this path.' => '如果您只想要汇入档案库的一部份，如 `trunk/`，您可以在 **只汇入** Phabricator 将会忽略那些不影响此路径的提交 (Commit)。',
  ...
  'Import Entire Repository' => '汇入整个档案库',
  'Import LDAP Users' => '汇入 LDAP 使用者',
  'Import Ldap Users' => '汇入 Ldap 使用者',
  'Import Only' => '只汇入',
  'Import Successful' => '汇入成功',
  'Import board columns from another project.' => '从其他项目汇入看板栏。',
  ...
  'Import or Observe an Existing Repository' => NULL,
  'Import to Maniphest' => NULL,
  'Import, create, or just browse repositories in Diffusion.' => '汇入、建立或浏览在 Diffusion 中的档案库。',
  'Import?' => '汇入?',
  ...
  'In Any: %s' => '在: %s',
  'In Any: ...' => '在: ...',
  'In Any: Invalid Project' => '在: 无效的项目',
  'In Asana' => NULL,
  'In Debt' => NULL,
...
%s' => NULL,
  ...
  'Include results tagged with this project.' => '挑选结果中标记此项目的项目。',
  'Include stories about projects I am a member of.' => '包含我所属项目的故事。',
  'Included Paths' => NULL,
  'Incomplete Cart' => NULL,
  'Incorrect' => NULL,
  'Incorrect Property Passed' => NULL,
  'Increase security (and improve performance) by configuring a CDN or alternate file domain.' => '设定 CDN 或替代的档案网域来增加安全性 (以及增加效率)。',
  'Indefinite' => NULL,
  'Index' => '首页',
  'Index Exists' => NULL,
  'Index Is Sane' => NULL,
  ...
  'Install this dashboard as the home page dashboard for %s?' => '安装这个资讯看板做为首页给 %s?',
  ...
  'Join this project? You will become a member and enjoy whatever benefits membership may confer.' => '加入此项目? 您将成为项目的一员并享受团队所带来的任何好处。',
  'Join works.' => NULL,
  'Joinable By' => '可加入由',
  'Joined' => '已加入',
  'Joined After' => '加入于之后',
  ...
  'Large File Storage Not Configured' => '未设定大型档案储存库',
  'Large Files' => NULL,
  'Large file storage has not been configured, which will limit the maximum size of file uploads. See %s for instructions on configuring uploads and storage.' => '尚未设定大型档案储存库，将会限制档案上传大小上限，请看 %s 取得设定上传与储存库的操作说明。',
  'Largest' => '最大',
  'Last' => NULL,
  'Last Author' => '最后作者',
  'Last Updated' => '上次更新于',
  ...
  'Linked Accounts and Authentication' => '已连结的帐号与认证',
...
Supported values are `8bit`, `quoted-printable`, `7bit`, `binary` and `base64`.' => NULL,
  ...
  'Make the workboard the default view for this project.' => '将此工作看板设为此项目预设的画面。',
  ...
  'Manage Project' => NULL,
  'Manage Repository' => '管理档案库',
  'Manage SSH Keys' => NULL,
  'Manage User' => NULL,
  ...
  'Maniphest Project Name Cache' => 'Maniphest 项目名称快取',
...
For complete instructions on editor configuration, see **[[ %s | %s ]]**.' => NULL,
  ...
  'Members: %s' => '成员: %s',
  'Members: ...' => '成员: ...',
  'Members: Invalid Project' => '成员: 无效项目',
  'Membership' => '成员资格',
  ...
  'Merge Duplicates Into This Task' => NULL,
  'Merge Into Selected Task' => NULL,
...
See __%s__ for more.' => NULL,
  ...
  'MySQL is Using Default Stopword File' => 'MySQL 使用预设的 Stopword 档案',
  ...
  'Name of the blueprint.' => NULL,
  'Name of the device.' => NULL,
  'Name of the event.' => NULL,
  'Name of the form.' => NULL,
  'Name of the namespace.' => NULL,
  'Name of the network.' => NULL,
  'Name of the package.' => NULL,
  'Name of the panel.' => NULL,
  'Name of the publisher.' => NULL,
  'Name of the queue.' => NULL,
  'Name of the service.' => NULL,
  'Name of the source.' => NULL,
  'Name of the task.' => NULL,
  'Name of the version.' => NULL,
  'Nameless Tab' => NULL,
  ...
  'Namespace %s' => NULL,
  'Namespace Name' => NULL,
  'Namespace name is required.' => NULL,
  'Namespaces' => '命名空间',
  'Natural' => '自然',
...
NOTE: Before you disable the queue, make sure {{auth.email-domains}} is configured correctly for your install!' => NULL,
  ...
  'No Authentication Providers Configured' => '尚未设定认证提供者',
  ...
  'No configured storage engine can store this file. See "Configuring File Storage" in the documentation for information on configuring storage engines.' => '尚未设定储存引擎可储存此档案。请参考文件 "设定档案储存库" 来取得设定储存引撆的资讯。',
  ...
  'No notification servers are configured.' => NULL,
  ...
  'No repository cluster services are configured.' => NULL,
  'No repository exists with PHID "%s".' => NULL,
  'No repository service "%s" exists.' => NULL,
  'No repository was found.' => '查无档案库。',
  ...
  'No tasks tagged with projects you are a member of need triage.' => '您所在的项目中的工作未被标记为需要分级。',
  'No tasks.' => NULL,
  ...
  'No valid databases are configured!' => NULL,
...
If you want updates to always require re-review, you can disable the "stickiness" of the "Accepted" status with this option. This may make the process for minor changes much more burdensome to both authors and reviewers.' => NULL,
  ...
  'Not Slack' => NULL,
  'Not Supported' => '不支援',
  'Not Tagged With Any Projects' => '未被标记任何项目',
  'Not Tracking Time' => NULL,
  'Not Unique' => NULL,
  'Not Visible' => NULL,
  'Not Working Now' => NULL,
  'Not a Hosted Repository' => '非代管档案库',
  'Not a Member' => NULL,
  ...
  'Notifications' => '通知',
  'Notifications User Guide: Setup and Configuration' => NULL,
...
(Note that if you run other applications against the same database, they may not work with %s. Be careful about enabling it in these cases and consider migrating Phabricator to a different database.)' => NULL,
  ...
  'Open Subtasks' => NULL,
  'Open Tasks' => '未完成的工作',
  'Open Tasks by Project and Priority (%s)' => '依项目与优先权未完成工作 (%s)',
  ...
  'Options for configuring Releeph, the release branch tool.' => '设定 Releeph 的选项，发布分支工具。',
  ...
  'Options relating to authentication.' => '有关认证相关的选项。',
  ...
  'Other initiative activity not listed above occurs.' => '上述未列到的其他提案活动。',
  ...
  'Other project activity not listed above occurs.' => '上述未列到的其他项目活动。',
...
%s' => NULL,
  ...
  'Phabricator Daemons Are Not Running' => '未执行 Phabricator Daemons',
...
Configure a CDN (or alternate file domain) to eliminate this risk. Using a CDN will also improve performance. See the guide below for instructions.' => NULL,
  ...
  'Phabricator is hosting this repository.' => 'Phabricator 正在代管此档案库。',
...
Accepting receivers: %s.' => NULL,
  'Phabricator is not configured in cluster mode.' => NULL,
  ...
  'Phabricator normally shows diffs in a side-by-side layout on large screens and automatically switches to a unified view on small screens (like mobile phones). If you prefer unified diffs even on large screens, you can select them for use on all displays.' => NULL,
...
This option defines a list of netblocks which Phabricator will decline to connect to. Generally, you should list all private IP space here.' => NULL,
  'Phabricator uses unicode glyphs in page titles to provide a compact representation of the current application. You can substitute plain text instead if these glyphs do not display on your system.' => NULL,
  ...
  'Phabricator will host this repository.' => 'Phabricator 将会代管此档案库。',
  'Phabricator will not push or pull any changes to this URI.' => NULL,
  'Phabricator will not retain a copy of the private key.' => NULL,
  'Phabricator will observe a remote repository.' => 'Phabricator 将会观察 (Observe) 远端档案库。',
  'Phabricator will observe changes to this URI and copy them.' => 'Phabricator 将会观察此 URI 的变更并复制这些变更。',
  ...
  'Phabricator will skip email verification for accounts registered through this provider.' => 'Phabricator 将会跳过透过此提供者注册的帐号的电子邮件验证。',
  ...
  'Please verify that you own this email address (%s) by clicking this link:' => '请点选此连结验证您拥有此邮件地址 (%s):',
  ...
  'Post-commit code review and auditing. Audits you are assigned to will appear here.' => '提交后程式码审查与稽查，指派给您的稽查会在此处显示。',
  'Postal Code' => NULL,
  ...
  'Project membership changes.' => '项目成员变更。',
  ...
  'Project name, hashtags, icon, image, or color changes.' => '项目名称、hashtags、图示、图片或色彩变更。',
  'Project name.' => NULL,
  'Project names must contain at least one letter or number.' => NULL,
  'Project tag color.' => NULL,
  'Project watcher list changes.' => '项目监视员清单变更。',
  'Project: %s' => NULL,
  'Projects' => '项目',
  'Projects (%s)' => NULL,
  'Projects User Guide' => NULL,
...
You **MUST** specify the root of the repository, not a subdirectory.' => '请输入这个 Subversion 档案库的 **档案库根目录**。您可以在工作复本执行 `svn info` 来查询，该值会看起来像以下例子:
...
| `https://bitbucket.org/example/repository`' => NULL,
  ...
  'Push a copy to a remote.' => 'Push 复本到远端。',
  'Pushable By' => '可推送由',
  'Pushed' => NULL,
  'Pushed At' => NULL,
  'Pushed By' => NULL,
  ...
  'Raw Data' => NULL,
  'Raw Diff' => '原始 Diff',
  'Raw Diff From File' => '自档案上传原始 Diff',
  ...
  'React to Phame Blogs being created or updated.' => NULL,
  'React to Phame Posts being created or updated.' => NULL,
...
These rules can reject diffs before they are written to permanent storage, to prevent users from accidentally uploading private keys or other sensitive information.' => NULL,
  'React to projects being created or updated.' => NULL,
...
Revision rules can send email, flag revisions, add reviewers, and run build plans.' => NULL,
  ...
  'Repository Active' => '档案库使用中',
  'Repository Autoclose Disabled' => NULL,
  'Repository Basics' => '档案库基本',
  'Repository Importing' => NULL,
  'Repository Inactive' => '档案库未使用',
  'Repository Operation %d' => NULL,
  'Repository Operations' => '档案库操作',
  'Repository PHID "%s" does not exist.' => NULL,
  'Repository PHID to create a new URI for.' => NULL,
  'Repository Pull Events' => '档案库 Pull 事件',
  'Repository Ref' => '档案库 Ref',
  'Repository Servers' => '档案库伺服器',
  'Repository URI' => '档案库 URI',
  'Repository URIs' => '档案库 URIs',
...
' => NULL,
  ...
  'Review the documentation describing how to import or observe an existing repository.' => NULL,
  'Review the repository operation queue.' => '审查档案库操作序列。',
  'Reviewed By' => NULL,
  'Reviewer' => '审查员',
  'Reviewers' => '审查员',
  'Reviewers: %s' => '审查员: %s',
  ...
  'Search Ngram' => NULL,
  'Search Parent Tasks' => NULL,
  'Search Posts' => NULL,
  'Search Scope' => NULL,
  'Search Subtasks' => NULL,
  ...
  'Select and reorder project fields.' => '请选择并重新排序项目栏位。',
...
NOTE: This feature is under active development and subject to change.' => NULL,
  ...
  'Select projects current viewer is a member of.' => '选择目前检视者所属的项目。',
  'Select repositories tagged with this project.' => '选择标记此项目的档案库。',
  ...
  'Send Another Verification Email?' => '寄发另一封验证邮件?',
...
' => NULL,
  ...
  'Send another copy of the verification email to %s?' => '寄发另一封验证邮件的复本到 %s?',
  ...
  'Show Only Manually Uploaded Files' => '只显示手动上传的档案',
  'Show Only Tasks With Open Parents' => NULL,
  'Show Only Tasks With Open Subtasks' => NULL,
  'Show Only Tasks Without Open Parents' => NULL,
  'Show Only Tasks Without Open Subtasks' => NULL,
  'Show Only Unapproved Users' => '只显示未核准的使用者',
  'Show Products' => NULL,
  'Show Prototype Applications' => '显示雏形应用程式',
  'Show Public Key' => NULL,
  'Show Raw File (Left)' => '显示原始档案 (左)',
  'Show Raw File (Right)' => '显示原始档案 (右)',
  'Show Recipient Hints' => NULL,
  'Show Released Applications' => '显示已发布应用程式',
  'Show Search' => '显示搜寻',
  'Show Secret' => '显示密码',
  ...
  'Some editors support opening multiple files with a single URI. You can specify the behavior of your editor here.' => NULL,
...
Commit(s) to reparse: %s' => NULL,
  ...
  'Specify the files and directories which comprise this package.' => '请指定组成此套件的档案与目录。',
...
With `ui.external`, you can use this artifact type to add links to build results in an external build system.' => NULL,
  ...
  'Subprocesses' => NULL,
  'Subprojects' => '子项目',
  'Subprojects and Milestones' => '子项目与里程碑',
  'Subprojects and milestones are only partially implemented.' => '子项目与里程碑仅部份实作。',
...
' => NULL,
  ...
  'Task Burn Rate for Project %s' => '项目 %s 的工作燃尽率',
  'Task Class' => NULL,
  ...
  'Terminate All Sessions' => '终止所有登入阶段',
...
The user that the webserver runs as must be able to read all the directories in PATH in order to make use of them.' => NULL,
  ...
  'The contents of this file were not changed.' => '此档案的内容没有变更。',
...
If this directory exists, make it readable to the webserver. You can also edit the configuration below to use some other directory.' => NULL,
  ...
  'The email address %s is now verified.' => '已验证邮件地址 %s。',
  ...
  'The name "%s" is not a valid repository short name. Repository short names may not contain only uppercase letters.' => '名称 "%s" 不是有效的档案库简短名称，档案库简短名称不可只使用大写字元。',
  'The name "%s" is not a valid repository short name. Repository short names may only contain letters, numbers, periods, hyphens and underscores.' => '名称 "%s" 不是有效的档案库简短名称，档案库简短名称只可含有字母、数字、句号、连字符以及底线。',
...
To learn more about how this issue affects Phabricator, see %s.' => NULL,
  ...
  'The workboard for this project has not been created yet.' => '此项目的工作看板尚未建立。',
  ...
  'There are no registered session engine extensions.' => NULL,
...
%s' => NULL,
  ...
  'This directory was copied from %s.' => '已复制此目录自 %s。',
  'This directory was copied to %s.' => '已复制此目录到 %s。',
  'This directory was deleted after being copied to %s.' => '已删除此目录在复制到 %s 之后。',
  'This directory was deleted.' => '已删除此目录。',
  'This directory was moved from %s.' => '已移动自此目录 %s。',
  'This directory was moved to %s.' => '已移动到此目录 %s。',
  ...
  'This email address has already been verified.' => '此邮件地址已经验证过。',
  ...
  'This file content has been collapsed.' => '已折叠此档案内容。',
  'This file data is incomplete!' => NULL,
  'This file has a very large number of changes (%s lines).' => '此档案有非常大量的变更 (%s 行)。',
  ...
  'This file is larger than %s, so blame is disabled.' => '这个档案大于 %s，已关闭 Blame。',
  'This file is larger than %s, so syntax highlighting is disabled by default.' => '这个档案大于 %s，预设会关闭语法标示。',
  ...
  'This file was added.' => '已新增此档案。',
  'This file was changed only by adding or removing whitespace.' => NULL,
  'This file was completely deleted.' => '已完全删除此档案。',
  'This file was converted from %s for display.' => NULL,
  'This file was copied from %s.' => '已复制此档案自 %s。',
  'This file was copied to %s.' => '已复制此档案到 %s。',
  'This file was deleted after being copied to %s.' => '已删除此档案在复制到 %s 之后。',
  'This file was deleted.' => '已删除此档案。',
  'This file was moved from %s.' => '已移动此档案自 %s。',
  'This file was moved to %s.' => '已移动此档案到 %s。',
...
您可以拖曳、移除、加入与编辑面板来自订此资讯看板的其余部份来呈现您想要的资讯。
...
您可使用上方动作连结中的 **安装资讯看板** 来安装此资讯看板做为首页。',
  ...
  'This is not a cluster repository.' => '此非丛集档案库。',
  ...
  'This newly created repository is not active yet. Configure policies, options, and URIs. When ready, %s the repository.' => '这个新建立的档案库尚未启用，请设定原则、选项以及 URI，当准备好时 %s 档案库。',
...
You should turn this option off (set it to 0) when you are done with it. Leaving it on creates a small amount of overhead for all requests, even if they do not hit the time limit.' => NULL,
  ...
  'This project does not have any members.' => '此项目尚未有任何成员。',
  'This project does not have any watchers.' => '此项目尚未有任何监视者。',
...
%s%s' => NULL,
  ...
  'This repository does not have any commits yet.' => '此档案库尚未有任何提交 (Commit)。',
  'This repository does not support Git LFS, so Git LFS URIs can not be generated for it.' => NULL,
  'This repository has no URIs.' => '此档案库没有任何 URI。',
  'This repository has no branches.' => '此档案库没有任何分支。',
  ...
  'This repository is hosted remotely. Phabricator is observing it.' => '此档案由远端代管，Phabricator 正在观察 (Observe) 该档案库。',
  ...
  'This repository will be updated soon!' => '此档案库将会尽快更新!',
  'This repository will become a new hosted repository. It will begin serving read and write traffic.' => NULL,
  'This repository will observe an existing remote repository. It will begin fetching changes from the remote.' => '此档案库将会观查一个已存在的远端档案库，并会开始自远端撷取变更。',
...
Requests must include a valid "Host" header.' => NULL,
  ...
  'This revision now requires changes to proceed.' => '这个修订现在需要进行变更。',
...
If not set, no log will be written.' => NULL,
  ...
  'To invite users to Phabricator, enter their email addresses below. Separate addresses with commas or newlines.' => '要邀请使用者到 Phabricator，请输入邀请使用者的邮件地址于下方，以逗号或换行隔开地址。',
...
' => NULL,
  ...
  'Trigger %d' => NULL,
  'Trigger Object' => NULL,
  'Trigger a build in CircleCI.' => NULL,
  ...
  'Trust Email Addresses' => '信任的电子邮件地址',
  ...
  'Type a package name...' => '请输入 Package 名称...',
  'Type a project name or function...' => '请输入项目名称或函数...',
  'Type a project name...' => '请输入项目名称...',
  'Type a publisher name...' => NULL,
  'Type a queue name...' => '请输入伫列名称...',
  'Type a repository name or function...' => '请输入档案库名称或函数...',
  'Type a repository name...' => '请输入档案库名称...',
  ...
  'Type a user or project name...' => '请输入使用者、项目名称',
  'Type a user, project name, or function...' => '请输入使用者、项目名称或函数...',
  'Type a user, project or package name...' => '请输入使用者、项目或套件名称...',
  'Type a user, project, or package name, or function...' => '请输入使用者、项目或套件名称或函数...',
  'Type a user, project, or package name...' => '请输入使用者、项目或套件名称...',
  'Type a user, project, package name or function...' => '请输入使用者、项目、套件名称或函数...',
  'Type a user, project, package, or mailing list name...' => '请输入使用者、项目或邮递清单名称...',
  'Type a username or "none"...' => '请输入使用者名称或 "none"...',
  'Type a username or function...' => '请输入使用者名称或函数...',
  'Type a username, project, mailing list, or function...' => '请输入使用者名称、项目、邮递清单或函数...',
...
%s' => NULL,
  ...
  'Use Parent Background (Default)' => NULL,
  'Use Picture' => '使用图片',
  ...
  'Use tabs to switch between several other panels.' => '使用页签来在数个面板间切换。',
  ...
  'User does not belong to any projects.' => '使用者未属于任何项目。',
  ...
  'User\'s Projects: %s' => '使用者的项目: %s',
  'User\'s Projects: Invalid User' => '使用者的项目: 无效的使用者',
  'Username' => '使用者名称',
  ...
  'Users with access may join and leave this project.' => '可存取的使用者可加入与离开此项目。',
  'Users with access may join this project, but may not leave.' => '可存取的使用者可加入此项目，但无法离开。',
  ...
  'Verify this email address (%s) and attach it to your account (%s)?' => '验证此邮件地址 (%s) 并连结到您的帐号 (%s)?',
  'Verify this email address (%s) and attach it to your account?' => '验证此邮件地址 (%s) 并连结到您的帐号?',
  ...
  'View Raw' => '检视原始资料',
  'View Raw Event' => NULL,
  'View Raw File' => '检视原始档案',
  'View Raw LFS Pointer' => NULL,
  'View Repository' => '检视档案库',
  'View Revision' => NULL,
  'View Side-by-Side' => '并排检视',
...
If you provide an instance identifier here (normally by injecting it with a `%s`), Phabricator will pass it to subprocesses and commit hooks in the `%s` environmental variable.' => NULL,
  ...
  'Waiting for daemons to build a working copy.' => '等候 Daemon 建立工作复本。',
...
NOTE: This feature is new and experimental.' => NULL,
  'When a revision is updated, Phabricator attempts to bring inline comments on the older version forward to the new changes. You can disable this behavior if you prefer comments stay anchored in one place.' => NULL,
...
All of the attribute names used here are just examples: your LDAP server may use different attribute names.' => NULL,
  ...
  'When viewing a revision or commit, you can enable a sidebar showing affected files. When this option is enabled, press {nav %s} to show or hide the sidebar.' => NULL,
...
This can make mail more useful, but some clients have difficulty threading these messages. Disabling this option may improve threading at the cost of making subject lines less useful.' => NULL,
  ...
  'Working' => NULL,
  'Working Copy' => NULL,
  'Working Copy Error' => '工作复本错误',
  'Working Copy OK' => '工作复本良好',
...
这些偏好设定 **仅会** 套用到您所连结到的物件 (例如，您为修订中的审查员或您在 CC 的工作)。当其他物件被建立、设定时要接收邮件通知，请设定 [[ /herald/ | Herald 规则 ]]。',
  'You can also paste a diff below, or upload a file containing a diff (for example, from %s, %s or %s).' => '您也可以在下方贴上 diff，或上传内含 diff 的档案 (例如使用 %s, %s 或 %s 产生的档案)。',
  'You can also upload files by dragging and dropping them from your desktop onto this page or the Phabricator home page.' => '您可以从您的桌面拖曳档案到此页面或 Phabricator 首页来上传档案。',
  'You can change your date and time preferences in Settings.' => NULL,
  'You can choose to use either a monospaced or variable-width font in textareas in the UI. Textareas are used for editing descriptions and writing comments, among other things.' => NULL,
  ...
  'You can create milestones for this project.' => '您可以建立此项目的里程碑',
  'You can create subprojects for this project.' => '您可以建立此项目的子项目',
...
As this feature is experimental, please read [[ %s | T4214 ]] for up to date information.' => NULL,
  'You can customize the font used when showing monospaced text, including source code. You should enter a valid CSS font declaration like: `13px Consolas`' => NULL,
...
' => NULL,
  ...
  'You can opt to receive plain text email from Phabricator instead of HTML email. Plain text email works better with some clients.' => NULL,
...
' => NULL,
  ...
  'You do not have permission to create new projects.' => '您没有权限建立新项目。',
  'You do not have permission to create new repositories.' => '您没有权限建立新档案库。',
  ...
  'You do not have permission to edit task projects.' => '您没有权限编辑工作项目。',
  'You do not have permission to edit task status.' => '您没有权限编辑工作状态。',
  'You do not have permission to edit this dashboard panel, but you can make a copy and edit that instead. If you choose to copy the panel, the original will be replaced with the new copy on this dashboard.' => '您没有权限编辑这个资讯看板面板，但您仍可复制并编辑。若您选择要复制面板，原来在这个资讯看板上的面板将会替换为新复制的面板。',
  'You do not have permission to edit this dashboard. If you want to make changes, make a copy first.' => '您没有权限编辑这个资讯看板。若您想要做变更，请先复制一份。',
  'You do not have permission to edit this object.' => '您没有权限编辑这个物件。',
  'You do not have permission to join this object.' => '您没有权限编辑加入此物件。',
  'You do not have permission to lock project membership.' => '您没有权限锁定项目成员资格。',
  'You do not have permission to manage Almanac cluster services.' => NULL,
  'You do not have permission to manage authentication providers.' => '您没有权限管理认证提供者。',
  ...
  'You do not have permission to view the configured credential.' => '您没有权限检视已设定的凭证。',
...
For more information, see "Managing Storage Adjustments" in the documentation.' => NULL,
  ...
  'You haven\'t added any authentication factors to your account yet.' => '您尚未加入任何认证 Factor 到您的帐号。',
  ...
  'You must provide a test plan. Describe the actions you performed to verify the behavior of this change.' => '您必须填写测试规划必填
，说明您做了那些动作来检验这次的变更。',
...
e.g.
  ...
  'You will receive mail that is sent to project members.' => '您将会收到寄发给项目成员的邮件。',
  'You\'re It' => NULL,
...
**Callsigns must be UPPERCASE**, and can not be edited after the repository is created. Generally, you should choose short callsigns.' => '**请为档案库输入一个 "代号"**，代号须为简短、独一无二的字串，用来在 Phabricator 辨识提交的位置。举例，您可以使用 `M` 代表手机 App 的档案库，`B` 代表后端的档案库。

**代号必须大写**，且在建立档案库之后无法变更。一般来说，您应使用一个简短的代号。',
  '**Choose a human-readable name for this repository**, like "CompanyName Mobile App" or "CompanyName Backend Server". You can change this later.' => '**请为这个档案库选择输入一个可阅读的名称**，例如 ""CompanyName Mobile App" 或 "CompanyName Backend Server"，您可以在往后变更此名称。',
  ...
  'Bot Account' => '机器人帐号',
  'Cacheable' => '可快取',
  'Calendar weeks will start with this day.' => '行事历会以此日做为开始。',
  'Callsign is required and must be ALL UPPERCASE LETTERS.' => '代号为必填且必须 "全部使用大写字元"。',
  'Change Projects' => '更改项目',
  'Choose the username and password used to connect to the repository hosted at:

  lang=text
  %s

If this repository does not require a username or password, you can continue to the next step.' => '请选择要用来连线至以下档案库的使用者名称及密码:

  lang=text
  %s

若这个档案不须要使用者名称及密码您可以直接继续下个步骤。',
  'Column Details' => '栏详细资讯',
  'Configure More Options First' => '先设定额外选项',
  'Configure more options before beginning the repository import. This will let you fine-tune settings. You can start the import whenever you are ready.' => '在开始汇入档案库前先设定额外选项，这可以让您微调设定，您可在您准备好后开始汇入。',
  'Create New...' => '建立新...',
  'Create OAuth Application' => '建立 OAuth 应用程式',
  'Create Public Event' => '建立公开事件',
  'Create Repository Now' => '马上建立档案库',
  'Create a New Hosted Repository' => '建立新的代管档案库',
  'Create a new, empty repository which Phabricator will host. For instructions on configuring repository hosting, see %s.' => '建立新的、空的档案库并由 Phabricator 代管。设定档案库代管详细指示请参考 %s。',
  'Create or Import Repository' => '建立或汇入档案库',
  'Creator: %s' => '建立者: %s',
  ...
  'Drag and drop images here to add them to the mock.' => '拖曳图片到这里将图片加入模型。',
  'Edit %s %s' => '编辑 %s %s',
...
You **MUST** specify the root of the repository, not a subdirectory. (If you want to import only part of a Subversion repository, use the //Import Only// option at the end of this workflow.)' => '请输入这个 Subversion 档案库的 **档案库根目录**。您可以在工作复本执行 `svn info` 来查询并查看 `Repository Root` 栏位的值。该值应该是一个 URI 且通常会看起来像:

| 范例 Subversion 档案库根目录 URIs |
| ------------------------------ |
| `http://svn.example.org/svnroot/` |
| `svn+ssh://svn.example.com/svnroot/` |
| `svn://svn.example.net/svnroot/` |
...
您 **必须** 填写档案库根目录而非子目录。(若您只想要汇入部份 Subversion 档案库，请使用 //Import Only// 选项，在此流程结束时。)',
  'Entire File Shown' => '已显示完整档案',
  'File Contents' => '档案内容',
  'Filter: %s' => '筛选: %s',
  ...
  'Human-readable repository name.' => '可阅读的档案库名称。',
  'If you disable **Email Notifications**, Phabricator will never send email to notify you about events. This preference overrides all your other settings.
...
//您可能仍想接收到部份管理邮件，例如密码重设邮件。//',
  'Import Repository' => '汇入档案库',
  'Import a Git repository (for example, a repository hosted on GitHub).' => '汇入 Git 档案库 (例如由 GitHub 代管的档案库)。',
  'Import a Mercurial repository (for example, a repository hosted on Bitbucket).' => '汇入 Mercurial 档案库 (例如由 Bitbucket 代管的档案库)。',
  'Import a Subversion repository.' => '汇入 Subversion 档案库。',
  'Import a repository hosted somewhere else, like GitHub, Bitbucket, or your organization\'s existing servers. Phabricator will read changes from the repository but will not host or manage it. The authoritative master version of the repository will stay where it is now.' => '汇入一个已架设在其他地方的档案库，例如在 GitHub, Bitbucket 或是您的组织既有的伺服器上。Phabricator 将会从档案库上读取变更旳资讯，但不会管理该档案库。档案库管理的主要版本仍会留在目前的所在位置。',
  'Import an Existing External Repository' => '汇入既有的外部档案库',
  'In Any Project' => '于任何项目内',
  ...
  'Leave Project...' => '离开项目...',
  'Link to edit files in external editor. %%f is replaced by filename, %%l by line number, %%r by repository callsign, %%%% by literal %%. For documentation, see: %s' => '在外部编辑器编辑档案的连结。%%f 会以档名取代、%%l 为行号、%%r 为档案库代号、%%%% 为文字 %%。说明文件请参考 %s。',
  ...
  'No tasks in projects you are a member of need triage.' => '您没有项目工作需要分级。',
  ...
  'Phabricator normally shows diffs in a side-by-side layout on large screens, and automatically switches to a unified view on small screens (like mobile phones). If you prefer unified diffs even on large screens, you can select them as the default layout.' => 'Phabricator 正常会在较大的画面使用并排版面显示 Diff，并在较小的画面自动切换合并检视 (如: 行动电话)。若您即使在较大的画面仍偏好合并检视，您可以选择合并检视做为预设版面。 ',
  'Prevent members from leaving this project.' => '避免成员离开此项目。',
  'Primary Hashtag' => '主要 Hashtag',
  'Project Activity' => '项目活动',
  'Recent Tasks' => '最近工作',
  'Repository Name and Location' => '档案库名称及位置',
  'Repository Ready!' => '档案库准备!',
  'Repository Remote URI' => '档案库远端 URI',
  'Repository Root' => '档案库根目录',
  'Repository Type' => '档案库类型',
  ...
  'Search for file names or content in this directory.' => '搜寻此目录的档案名称或内容。',
  'Select access policies for this repository.' => '选择存取这个档案库的原则。',
  'Send Message' => '传送讯息',
  ...
  'Start Now' => '现在开始',
  'Start importing the repository right away. This will import the entire repository using default settings.' => '立即开始汇入档案库，这个动作将会使用预设设定来汇入整个档案库。',
  ...
  'Type a user, project, or mailing list name...' => '请输入使用者、项目或邮递清单名称...',
  'Unstable Method: %s' => '不稳定方法: %s',
  'Use Default' => '使用预设值',
  'Use Default Colors' => '使用预设色彩',
  'Used By' => '使用由',
  'User Account' => '使用者帐号',
  'Users who can edit a project can always join a project.' => '能够编辑项目的使用者随时可加入项目。',
  'View Full History' => '检视完整历史记录',
  'Viewable Image' => '可检视图片',
  'Waiting on Others' => '等待其他人',
  'When looking at a revision or commit, enable a sidebar showing affected files. You can press %s to show or hide the sidebar.' => '当在查看修订或提交时，开启侧边栏显示影响的档案。您可按 %s 键来显示或隐藏侧边栏。',
  'You can not update the Lock Project setting.' => '您无法更新锁定项目的设定。',
